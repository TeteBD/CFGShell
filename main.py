...
def vim():
    ...
    if opt == "1":
        ...
        print("")
        print("[+] Log")
        os.system("cd;git clone --depth=1 https://github.com/amix/vimrc.git ~/.vim_runtime;sh ~/.vim_runtime/install_awesome_vimrc.sh;wget https://raw.githubusercontent.com/TeteBD/CFGShell/main/res/Vimrc/vimrc;mv vimrc .vimrc")
        print("")
